 ...
 */
class PersonalUtilAdapter : BaseQuickAdapter<PersonalUtilBean, BaseViewHolder> {

    private var mItemClickTime = 0L
    private var mTimeInterval = 800

    constructor(list: MutableList<PersonalUtilBean>) : super(R.layout.item_personal_util_horizontal, list)
