...
public class StatusBarUtil {
    ...
    /**
     * SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN：该flag 会将Activity设置为全屏，如果不需要全屏，可以在页面跟布局中添加 fitSystemWindow=true 进行设置
     */
    ...
    /**
     * 设置状态栏文字颜色（要求 Adnroid6.0 以上版本）
     * @param isLightMode ：是否高亮，如果是高亮模式，则状态栏文本颜色会变为深色
     */
    public static void setLightModeNotFullScreen(Activity activity, boolean isLightMode) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
