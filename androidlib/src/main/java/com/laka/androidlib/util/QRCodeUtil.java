...
public class QRCodeUtil {
     ...
     */
    @Nullable
    public static Bitmap createQRCodeBitmap(@Nullable String content, int size, int margin) {
     ...
     */
    @Nullable
    public static Bitmap createQRCodeBitmap(String content, int size, int margin, @Nullable Bitmap logoBitmap, float logoPercent) {
