package com.laka.androidlib.util.image.transformation;
 ...
 * @Author:Rayman
 * @Date:2019/1/25
 * @Description:抽取GlideImageLoader中的RoundCornerBitmap .
 * Glide圆角裁剪类
 */
...
public class RoundedCornersTransformation extends BitmapTransformation {
    ...
    private static final String ID = "com.laka.androidlib.util.image.transformation.RoundedCornersTransformation." + VERSION;
