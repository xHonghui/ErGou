            ...
            case TYPE_GRID:
                switch (orientation) {
                    case ORIENTATION_VERTICAL:
                        //第三个参数设置 RecyclerView 方向排序
                        mLayoutManager = new CustomGridLayoutManager(mContext, column, GridLayoutManager.VERTICAL, true);
                        break;
                    case ORIENTATION_HORIZONTAL:
                        mLayoutManager = new CustomGridLayoutManager(mContext, column, CustomGridLayoutManager.HORIZONTAL, true);
                        break;
                }
                break;
            case TYPE_STAGGER:
